    ...
    while (!quit) {
      ...
      while (SDL_PollEvent(&ev)) {
        ...
        case SDL_WINDOWEVENT:
          ...
          // első megjelenéskor. Szerintünk ez bug az SDL könytárban. Ezért ezt
          // az esetet külön lekezeljük, mivel a MyApp esetlegesen tartalmazhat
          // ablak méret függő beállításokat, pl. a kamera aspect ratioját a
          // perspective() hívásnál.
